"""
Testing world setup for the house adventure game.
...
def demo():
    ...
    # --- Add Items, Characters, etc. ---
    bed = things.Item("bed", "comfortable bed", "A soft bed for sleeping.")
    ...
    custom_actions = [
        ...
        Sleep, MakeBed, CleanBed, ChangeQuilt, Legend
    ]
