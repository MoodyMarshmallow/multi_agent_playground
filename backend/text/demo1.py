...
bed.set_property("is_shown", True)
...
closet.set_property("is_shown", True)
...
dresser.set_property("is_shown", True)
...
alarm_clock.set_property("is_shown", False)
...
clothes.set_property("is_shown", False)
...
fridge.set_property("is_shown", True)
...
oven.set_property("is_shown", True)
...
sink.set_property("is_shown", True)
...
cabinets.set_property("is_shown", True)
...
trash_can.set_property("is_shown", True)
...
microwave.set_property("is_shown", False)
...
toaster.set_property("is_shown", False)
...
coffee_maker.set_property("is_shown", False)
...
bread.set_property("is_shown", False)
...
apple.set_property("is_shown", False)
...
milk.set_property("is_shown", False)
...
cup.set_property("is_shown", False)
...
bowl.set_property("is_shown", False)
...
fork.set_property("is_shown", False)
...
knife.set_property("is_shown", False)
...
spoon.set_property("is_shown", False)
...
entry_door.set_property("is_shown", True)
...
welcome_mat.set_property("is_shown", False)
...
key.set_property("is_interactable", True)
key.set_property("is_shown", False)
key.set_property("material", "metal")
key.set_property("color", "gold")
entry.add_item(key)
...
dining_table.set_property("is_shown", True)
...
chairs.set_property("is_shown", True)
...
tableware.set_property("is_shown", False)
...
toilet.set_property("is_shown", True)
...
bath_sink.set_property("is_shown", True)
...
bathtub.set_property("is_shown", True)
...
shower.set_property("is_shown", True)
...
medicine_cabinet.set_property("is_shown", True)
...
medicine.set_property("is_shown", False)
...
toothbrush.set_property("is_shown", False)
...
toothpaste.set_property("is_shown", False)
...
washer.set_property("is_shown", True)
...
dryer.set_property("is_shown", True)
...
laundry_basket.set_property("is_shown", False)
...
detergent.set_property("is_shown", False)
...
couch.set_property("is_shown", True)
...
bookshelf.set_property("is_shown", True)
...
lamp.set_property("is_shown", True)
...
remote_control.set_property("is_shown", False)
...
book.set_property("is_shown", False)
...
board_game.set_property("is_shown", False)
...
game_table.set_property("is_shown", True)
...
arcade_machine.set_property("is_shown", True)
...
game_pieces.set_property("is_shown", False)
...
scoreboard.set_property("is_shown", False)
scoreboard.set_property("score", 0)
game.add_item(scoreboard)

# Outdoor/Utility SIOs
...
mailbox.set_property("is_shown", True)
mailbox.set_property("has_mail", False)
mailbox.set_property("color", "white")
# Not added to a room, but would be in an outdoor location
...
garden_hose.set_property("is_shown", True)
...
grill.set_property("is_shown", True)
...
lawn_mower.set_property("is_shown", True)
...
door_outside.set_property("is_shown", True)
door_outside.set_property("is_broken", False)
# Outdoor/Utility HIOs
...
garden_tools.set_property("is_shown", False)
...
plants.set_property("is_shown", False)
...
light_switch.set_property("is_shown", True)
...
thermostat.set_property("is_shown", True)
...
phone.set_property("is_shown", True)
...
computer.set_property("is_shown", True)
...
flashlight.set_property("is_shown", True)
...
battery.set_property("is_shown", False)
...
custom_actions = [
    OpenCloseItem, CloseItem, TakeFromContainer,
    UnlockDoor, LockDoor, TurnOnSink, TurnOffSink, FillCup, FillBathtub, UseWashingMachine,
    WatchTV, PlayPool, TakeBath, UseComputer
]
